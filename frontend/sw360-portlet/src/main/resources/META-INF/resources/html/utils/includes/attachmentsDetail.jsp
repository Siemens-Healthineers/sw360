                        ...
                        success: function (data) {
                            if (!data || data.length == 0 || Object.getOwnPropertyNames(data).length == 0) {
                                ...
                                if (data.message && data.message.length) {
                                    ...
                                    if (result !== 'SUCCESS') {
                                        statusDiv.html('<h3><liferay-ui:message key="sbom.import.failed" />: <span class="text-info">' + data.fileName + '</span></h3>');
                                        if (result == 'DUPLICATE') {
                                            statusDiv.append("<div class='alert alert-warning'><b>" + result + "</b> <br>" + data.message + "<br>");
                                        } else {
                                ...
                                if (data.invalidRel && data.invalidRel.length) {
                                    ...
                                    statusDiv.append("<div class='alert alert-info'><liferay-ui:message key="list.of.components.without.version.information" />: <b>" + $(invalidRelList).find('li').length +
