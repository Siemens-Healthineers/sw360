...
<div class="dialogs">
	<div id="search-releases-div" data-title="<liferay-ui:message key="search.releases" />" class="modal fade" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
			...
			<div class="modal-body container">
		        ...
		        <button type="button" class="btn btn-light" data-dismiss="modal"><liferay-ui:message key="close" /></button>
			        <button id="search-add-button" type="button" class="btn btn-primary"><liferay-ui:message key="link.releases" /></button>
			    </div>
			</div>
		</div>
	</div>
