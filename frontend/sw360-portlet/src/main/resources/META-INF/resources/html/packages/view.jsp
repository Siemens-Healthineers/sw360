                    ...
                    <div class="card-body">
                        <form action="<%=applyFiltersURL%>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <sup title="Packages not linked to any release" type="button">
    ...
    require(['jquery', 'modules/autocomplete', 'modules/dialog', 'bridges/datatables', 'utils/render' ], function($, autocomplete, dialog, datatables, render) {
        ...
        function createPackagesTable() {
            let columns = [
                ...
                {"title": "<liferay-ui:message key='release.name' />", data: "relName", defaultContent: "", render: {display: renderReleaseNameLink}, width: "25%"},
