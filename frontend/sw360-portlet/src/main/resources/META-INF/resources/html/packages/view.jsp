                ...
                <div id="searchInput" class="card">
                    ...
                    <div class="card-body">
                        <form action="<%=applyFiltersURL%>" method="post">
                            ...
                            <div class="form-group">
                                <label for="package_type"><liferay-ui:message key='package.manager.type' /></label>
                            ...
                            <div class="form-group">
                                ...
                                <sup title="<liferay-ui:message key="the.search.result.will.display.elements.exactly.matching.the.input.equivalent.to.using.x.around.the.search.keyword" /> <liferay-ui:message key="applied.on.package.name.and.version" />">
    ...
    require(['jquery', 'modules/autocomplete', 'modules/dialog', 'bridges/datatables', 'utils/render' ], function($, autocomplete, dialog, datatables, render) {
        ...
        function createPackagesTable() {
            let columns = [
                ...
                {"title": "<liferay-ui:message key='release.name' />", data: "relName", render: {display: renderReleaseNameLink}, width: "25%"},
                {"title": "<liferay-ui:message key='release.clearing.state' />", data: "relCS", render: {display: renderReleaseCS}, width: "10%"},
                {"title": "<liferay-ui:message key="licenses" />", data: "lics", render: {display: renderLicenseLink}, width: "15%"},
                {"title": "<liferay-ui:message key='package.manager' />", data: "pkgMgrType", width: "20%"},
