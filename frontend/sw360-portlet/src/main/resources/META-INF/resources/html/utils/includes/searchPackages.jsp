			...
			<div class="modal-body container">
                    ...
                    <form>
                        <div class="row form-group">
	                        ...
	                        <div id="pkgTruncationAlert" class="alert alert-warning" role="alert" style="display: none;">
                        ...
                        <div class="form-check pt-2">
                            ...
                            <core_rt:if test="${portletName == 'sw360_portlet_components'}">
                                <span class="alert alert-info my-0 p-1 mx-4">Only orphan packages can be searched & linked to release.</span>
                            </core_rt:if>
                        </div>
...
<script>
    require(['jquery', 'modules/dialog', 'bridges/datatables', 'utils/keyboard', /* jquery-plugins */ 'jquery-ui' ], function($, dialog, datatables, keyboard) {
       var $dataTable,
        ...
        //$('#addLinkedPackagesToProjectButton').on('click', showPackageDialog);
        $('#searchBtnPackage').on('click', function(){
            ...
            packageContentFromAjax('<%=PortalConstants.PACKAGE_SEARCH%>', searchPackage, function(data) {
                ...
                addLinkToPackageNameAndVersion();
        ...
        function addLinkToPackageNameAndVersion() {
            $('#packageSearchResultsTable > tbody  > tr').each(function() {
                let $pkgId = $('td:eq(0)', this).find("input[type='checkbox']").val();
                let $pkgName = $('td:eq(1)', this);
                let $pkgVersion = $('td:eq(2)', this);
                let linkOnPkgName = detailUrl($pkgName.text(), makePackageViewUrl($pkgId));
