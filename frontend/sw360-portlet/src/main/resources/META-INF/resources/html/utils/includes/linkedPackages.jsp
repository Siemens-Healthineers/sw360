        ...
        function createLinkedPackagesTable(packagesJsonData) {
            if (isProjectPortlet) {
                var columns = [
                    ...
                    {title: "<liferay-ui:message key='package.manager' />", data: "pkgMgrType", className: 'noSearch filter', width: "7%"},
                ...
                var columns = [
                    ...
                    {title: "<liferay-ui:message key='package.manager' />", data: "pkgMgrType", className: 'noSearch filter', width: "15%"},
