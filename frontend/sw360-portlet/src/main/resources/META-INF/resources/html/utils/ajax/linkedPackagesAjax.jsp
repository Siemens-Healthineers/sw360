...
<core_rt:forEach items="${packageList}" var="pkg" varStatus="loop">
            ...
            <tr id="packageLinkRow_${uuid}" >
                ...
                <td>
                    <input id="packageManagerType" type="text" class="form-control"
                        value="<sw360:DisplayLicenseCollection licenseIds="${pkg.licenseIds}" scopeGroupId="${pageContext.getAttribute('scopeGroupId')}" />" readonly/>
                </td>
                <td>
                    <div class="form-group">
                        <input id="packageManagerType" type="text" class="form-control"
                            value="<sw360:out value="${pkg.packageManagerType}"/>" readonly/>
                    </div>
                </td>
