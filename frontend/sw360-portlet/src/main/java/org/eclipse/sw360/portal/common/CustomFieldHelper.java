...
import static org.eclipse.sw360.portal.common.PortalConstants.CUSTOM_FIELD_CLEARING_REQUEST_MESSAGE;
...
public class CustomFieldHelper {
    ...
    private static ExpandoBridge getUserExpandoBridge(PortletRequest request, User user) throws PortalException, SystemException {
        ...
        ensureUserCustomFieldExists(liferayUser, CUSTOM_FIELD_CLEARING_REQUEST_MESSAGE, ExpandoColumnConstants.STRING);
