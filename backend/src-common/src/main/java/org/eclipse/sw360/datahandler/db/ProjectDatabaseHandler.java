...
public class ProjectDatabaseHandler extends AttachmentAwareDatabaseHandler {
    ...
    public AddDocumentRequestSummary addProject(Project project, User user) throws SW360Exception {
        ...
        if (!isDependenciesExists(project, user) || (BackendUtils.IS_PACKAGE_PORTLET_ENABLED && isReleasesUpdateFromLinkedPackagesFailed(project, Collections.emptySet()))) {
    ...
    public RequestStatus updateProject(Project project, User user, boolean forceUpdate) throws SW360Exception {
        ...
        } else if (!isDependenciesExists(project, user) || (BackendUtils.IS_PACKAGE_PORTLET_ENABLED &&
                isReleasesUpdateFromLinkedPackagesFailed(project, CommonUtils.nullToEmptySet(actual.getPackageIds())))) {
     ...
     */
    private boolean isReleasesUpdateFromLinkedPackagesFailed(Project updatedProject, Set<String> currentPackageIds) throws SW360Exception {
